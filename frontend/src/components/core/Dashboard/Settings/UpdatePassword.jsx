        ...
        <div className='my-5 rounded-md border border-richblack-700 bg-richblack-800 p-8 px-12'>
          ...
          <div className='flex flex-col lg:flex-row gap-5' >
            <div className='relative flex flex-col gap-x-2 w-full' >
              <label htmlFor="oldPassword" className='text-[14px] text-richblack-5 uppercase tracking-wider mb-1' >Your Password <span className='text-pink-100'>*</span></label>
              <input
                name='oldPassword'
                id='oldPassword'
                placeholder='Enter Current Password'
                type={showOldPassword ? 'text' : 'password'}
                className='rounded-lg bg-richblack-700 p-3 text-[16px] leading-[24px] text-richblack-5 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-richblack-400 focus:outline-none !pr-12 placeholder:uppercase placeholder:text-sm placeholder:tracking-wider'
