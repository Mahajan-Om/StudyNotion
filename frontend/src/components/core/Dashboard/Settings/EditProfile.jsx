          ...
          <div className='flex flex-col gap-y-6'>
            <div className='flex flex-col md:flex-row gap-5'>
              ...
              <label className='w-full' >
                <p className='text-[14px] text-richblack-5 uppercase tracking-wider mb-1'>First Name <span className='text-pink-100'>*</span></p>
                <input
                  type='text'
                  name='firstName'
                  placeholder='Enter first name'
                  defaultValue={user?.firstName}
                  className='rounded-lg bg-richblack-700 p-3 text-[16px] leading-[24px] text-richblack-5 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-richblack-400 focus:outline-none w-full placeholder:uppercase placeholder:text-sm placeholder:tracking-wider'
              ...
              <label className='w-full' >
                <p className='text-[14px] text-richblack-5 uppercase tracking-wider mb-1' >Last Name <span className='text-pink-100'>*</span></p>
                <input
                  type='text'
                  name='lastName'
            ...
            <div className='flex flex-col md:flex-row gap-5'>
              ...
              <label className='w-full' >
                <p className='text-[14px] text-richblack-5 uppercase tracking-wider mb-1' >Date of Birth <span className='text-pink-100'>*</span></p>
                <input
                  type='date'
                  name='dob'
              ...
              <label className='w-full' >
                <p className='text-[14px] text-richblack-5 uppercase tracking-wider mb-1' >Gender <span className='text-pink-100'>*</span></p>
                <select
                  type='text'
                  name='gender'
                  className='rounded-lg bg-richblack-700 p-3 text-[16px] leading-[24px] text-richblack-5 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-richblack-400 focus:outline-none w-full'
            ...
            <div className='flex flex-col md:flex-row gap-5'>
              ...
              <label className='w-full' >
                <p className='text-[14px] text-richblack-5 uppercase tracking-wider mb-1' >Contact Number <span className='text-pink-100'>*</span></p>
                <input
                  type='tel'
                  name='contactNumber'
              ...
              <label className='w-full' >
                <p className='text-[14px] text-richblack-5 uppercase tracking-wider mb-1' >About <span className='text-pink-100'>*</span></p>
                <input
                  type='text'
                  name='about'
